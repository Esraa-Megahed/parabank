...
import pages.UpdateInfPage;

public class UpdateInfTest extends BaseTest {
    ...
    String SSNField = ("9");
    String UserNameField = ("oppei");
    String PassWordField = ("Vois_999999");
    String ConfirmField = ("Vois_999999");

    @Test
    public void ValidateUpdateInf() throws InterruptedException {
        ...
        homePage.updateInf();
        UpdateInfPage updateInfPage = new UpdateInfPage(driver);
        updateInfPage.newUpdate(updateInfPage.getFirstNameField(), "rosita");
